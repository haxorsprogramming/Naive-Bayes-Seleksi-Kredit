...
<body style="font-family: 'Nunito', sans-serif;">
    <div class="container-scroller">
        <div class="container-fluid page-body-wrapper full-page-wrapper">
                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left py-5 px-4 px-sm-5" id='login-app'>
                                <div class="brand-logo" style='text-align:center;'>
                                    <img src="{{ asset('ladun/loginpage/images/bank.png') }}" alt="logo" style='width:150px; '>
                                    <h3 style="font-weight:bold;margin-top:40px;">Sistem Pendukung Keputusan</h3>
                                    <h4>Pemberian Kelayakan Kredit</h4>
                                </div>
                                        ...
                                        <div class="pt-3">
                                            ...
                                            <div class="mt-2">
                                                <div style='padding-top:12px;'>
                                                    <h5 class="font-weight-light">{{ env('YEAR_DEVELOPMENT') }} &copy; <a href='http://haxors.or.id' target='new'>{{ env('APP_DEVELOPER') }}</a></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <script src="ladun/loginpage/js/login.js"></script>
